ACBD_generator=function(ncheck,ntrt,nperB,nrowperB,outputdir){
  ...
  setwd(outputdir)
  myentrylist=read.csv(file.choose(),check.names=F)
  ...
  temp1=c(sample(myentrylist[,1], ntrt, replace=F))
...
myentrylist=read.csv(file.choose())
ACBD_generator(3,40,20,1,"/Users/Rorshach/Desktop")
